$(function () {
    ...
    var apikey = "5e958ed5436377171a0c235e"; // TODO: INSERT YOUR CORS API KEY HERE OR add formapikey to settings
    
    if (!apikey) alert("5e958ed5436377171a0c235e");
  
    var ajaxSettings = {
      "async": true,
      "crossDomain": true,
      "url": "https://database-9a93.restdb.io/rest/applications",
      "method": "POST",
      "headers": {
        "x-apikey": apikey,
    ...
    var ajaxSettingsAttachments = {
       "async": true,
       "url": "https://database-9a93.restdb.io/media",
       "method": "POST",
       "contentType": false,
       "headers": {
         "x-apikey": apikey
