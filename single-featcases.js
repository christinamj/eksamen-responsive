let side = {};
let indhold;
const featuredurl = "http://csmedier.dk/responsive-wp/wordpress/wp-json/wp/v2/featuredcases/";
let urlParams = new URLSearchParams(window.location.search);
let featuredcase = urlParams.get("featuredcase");
...
async function hentJson() {
    const url = featuredurl + featuredcase;
